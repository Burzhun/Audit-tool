...
export default class ScatterChartView extends React.Component {
    ...
    return (
      <div className="highlight-bar-charts">
          ...
          >
            ...
            <Scatter key="key1" data={data} yAxisId="y1" barSize={300}  name="l1" xAxisId="x1"   onClick={this.handleClick.bind(this)}   animationDuration={300}/>
            {selectedPoint && !this.state.selectedPointOver && <ReferenceDot yAxisId="y1" xAxisId="x1"  x={selectedPoint.x} y={selectedPoint.y} r={4} fill="red" isFront={true} alwaysShow={true} >
              </ReferenceDot>
            }
              ...
              return (
                [               
                  <Scatter key={"additional_record"+index} fill={record.color}
                    data={record.data}
                    yAxisId="y1" barSize={300}  name="l1" xAxisId={xId}   animationDuration={300}/>,
                    xLog ?  <XAxis                     
