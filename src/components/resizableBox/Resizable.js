...
export default class Resizable extends React.Component {
  ...
  resizeHandler(handlerName, axis) {
    return (e, { node, deltaX, deltaY }) => {
      ...
      const widthChanged = width !== this.props.width; const
        heightChanged = height !== this.props.height;
  ...
  renderResizeHandle(resizeHandle) {
    ...
    return React.createElement('span', { className: `react-resizable-handle react-resizable-handle-${resizeHandle}` });
  }

  render() {
    // eslint-disable-next-line no-unused-vars
    const _a = this.props; const {
      children, draggableOpts, width, height, handleSize, lockAspectRatio, axis, minConstraints, maxConstraints, onResize, onResizeStop, onResizeStart, resizeHandles, transformScale,
    } = _a; const
      p = __rest(_a, ['children', 'draggableOpts', 'width', 'height', 'handleSize', 'lockAspectRatio', 'axis', 'minConstraints', 'maxConstraints', 'onResize', 'onResizeStop', 'onResizeStart', 'resizeHandles', 'transformScale']);
    ...
    return cloneElement(children, {
      ...
      children: [
        ...
        resizeHandles.map((h) => (React.createElement(DraggableCore, {
          ...draggableOpts, key: `resizableHandle-${h}`, onStop: this.resizeHandler('onResizeStop', h), onStart: this.resizeHandler('onResizeStart', h), onDrag: this.resizeHandler('onResize', h),
