...
module.exports = async (req, res, next) => {
    try {
        ...
        logKabana(
            [
                {
                    new_Value: { DefaultFieldsToDisplayInAuditSession: validSelected },
                    old_Value: { DefaultFieldsToDisplayInAuditSession: configuration.DefaultFieldsToDisplayInAuditSession },
